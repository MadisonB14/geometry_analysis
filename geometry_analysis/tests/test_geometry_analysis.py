...
def test_calculate_angle_90():
    ...
    #you may have a guess that is close to what the code says, you can use the following function to test if close
...
def test_calculate_angle_60():
    ...
    #the above 2 functions are very similar, you can use a decorator to quicken this
@pytest.mark.parametrize("p1, p2, p3, expected_angle", [
    (np.array([1, 0, 0]), np.array([0, 0, 0]), np.array([0, 1, 0]), 90), #p1, p2, p3, 90
